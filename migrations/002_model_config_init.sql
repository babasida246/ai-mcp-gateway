...
INSERT INTO layer_configs (layer, enabled, model_ids, fallback_models, metadata)
VALUES 
    ('L0', true, ARRAY[]::TEXT[], ARRAY[]::TEXT[], '{}'),
...
-- L0 Models (Free tier)
INSERT INTO model_configs (id, provider, api_model_name, layer, relative_cost, price_per_1k_input_tokens, price_per_1k_output_tokens, context_window, enabled, capabilities)
VALUES 
    ...
    ('openrouter-grok-free', 'openrouter', 'x-ai/grok-beta', 'L0', 0, 0, 0, 131072, true, '{"code": true, "general": true, "reasoning": true}')
...
INSERT INTO task_model_preferences (task_type, model_ids, enabled)
VALUES 
    ('chat', ARRAY['openrouter-llama-3.3-70b-free', 'openrouter-gemini-flash'], true),
